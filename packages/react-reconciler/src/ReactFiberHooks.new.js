...
// 如果执行到了updateEffectImpl，
// 肯定组件已经更新了,useEffect的函数体已经执行过一次了
...
// 1. 创建一个update
  ...
  if (
    ...
    // 4. 最后调用一次scheduleUpdateOnFiber，进入调度，触发function重新执行一次
